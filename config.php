...
// Site Path
define("SITE_URL", "http://localhost/restro_business/admin/api/");
define("ADMIN_PATH", "http://localhost/restro_business/admin/"); 
define("BASE_PATH", "http://localhost/restro_business/");
define("DOC_PATH", "/opt/lampp/htdocs/restro_business/admin/");
