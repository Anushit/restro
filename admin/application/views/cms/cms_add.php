      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">  
           <!-- For Messages -->
            ...
            <?php echo form_open_multipart(base_url('cms/add'), 'class="form-horizontal" id="cmsForm"');  ?> 
              ...
              <div class="form-group row"> 
                ...
                <div class="col-sm-12">
                  <textarea name="cms_contant" value=""class="form-control textarea" id="cms_contant" placeholder=""><?= set_value('cms_contant'); ?></textarea> 
                </div>
              </div>
              ...
              <div class="form-group row">         
                ...
                <label class="control-label">Banner Image</label><br/>
                  <?php if(!empty($service['cms_banner'])): ?>
                     <p><img src="<?= base_url($service['cms_banner']); ?>" class="image logosmallimg"></p>
                 <?php endif; ?>
                 <input type="file" name="cms_banner" id="cms_banner">
                 <p><small class="text-success">Allowed Types: gif, jpg, png, jpeg</small></p>
                 <input type="hidden" name="old_banner" value="<?php echo html_escape(@$service['cms_banner']); ?>">
               </div>
              </div>
              <div class="form-group row">
                <div class="col-md-12">
                  <input type="submit" name="submit" value="Add CMS" class="btn btn-submit btn-info pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
          <!-- /.box-body -->
