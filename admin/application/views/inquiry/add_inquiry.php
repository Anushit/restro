           ...
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('inquiry/add'), 'class="form-horizontal" id="inquiryForm"');  ?> 
              ...
              <div class="form-group row">     
                ...
                <div class="col-sm-6">
                  <label for="referral_id" class="col-sm-6 control-label">Referral <span class="red">*</span></label>
                  <select name="referral_id" id="referral_id" onchange ="get_state(this)" class="form-control">
                    <option value="">Select Referral </option>
                    <?php foreach ($referral as $key => $value) {?>
                     <option value="<?= $value['id']?>" <?= set_value('referral_id') ?>><?= $value['name']?>
                    </option>
                   <?php  } ?>
                  </select>
                </div>
