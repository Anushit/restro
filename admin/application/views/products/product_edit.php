      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           ...
           <!-- For Messages -->
            ...
            <?php echo form_open_multipart(base_url('product/edit/'.$pro['id']), 'class="form-horizontal"');  ?> 
              ...
              <div class="form-group row">
                ...
                <label for="model" class="col-sm-6 control-label">Model <span class="red">*</span></label>  
                  <input type="text" name="model" class="form-control" id="name" placeholder="" value="<?= set_value('model',$pro['model']); ?>">
                </div>
                <div class="col-sm-6">
              ...
              <div class="form-group row">
                ...
                <label for="sort_description" class="col-sm-6 control-label">Sort Description <span class="red">*</span></label>  
                  <input type="text" name="sort_description" class="form-control" id="sort_description" placeholder="" value="<?= set_value('sort_description',$pro['sort_description']); ?>">
                </div>
              </div>
              <div class="form-group row">
                <div class="col-sm-6">
                ...
                <label for="special_price" class="col-sm-6 control-label">Special Price </label>  
                  <input type="text" name="special_price" class="form-control" id="sku" placeholder="" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/[^\d\.]/g, '')" value="<?= set_value('special_price',$pro['special_price']); ?>">
                </div>
              </div>
              <div class="form-group row">
                <div class="col-sm-6">
              ...
              <div class="form-group row"> 
                ...
                <?php 
                  foreach ($proimage as $ikey => $ivalue) {  
                    if($ikey==0){
                      $htmlData = '<div class="row"><div class="col-sm-5"><input type="file" name="image['.$image_row.'][image]" accept=".png, .jpg, .jpeg, .gif, .svg"> <small class="text-success" style="vertical-align: top;">Allowed Types: gif, jpg, png, jpeg</small></div>';   
                ...
                <?php $image_row++; ?>
                <div class="col-md-6" style="margin-top:15px;"> <input type="button" name="addimg" value="Add Image" class="btn btn-waring addimg"> </div>
