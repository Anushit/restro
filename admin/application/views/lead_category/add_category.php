      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-header">
          ...
          <div class="d-inline-block">
              ...
              Add New Lead Category </h3>

          </div>

          <div class="d-inline-block float-right">

            <a href="<?= base_url('role'); ?>" class="btn btn-success"><i class="fa fa-list"></i>  Lead Category List</a>
        ...
        <div class="card-body col-lg-6">   
           ...
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('lead_category/add'), 'class="form-horizontal" id="roleForm"');  ?> 
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <input type="submit" name="submit" value="Add Lead Category" class="btn btn-info pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
          <!-- /.box-body -->
