      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           ...
           <!-- For Messages -->
            ...
            <?php echo form_open_multipart(base_url('gallery/editvideo/'.$gallery['id']), 'class="form-horizontal" id="videoForm"');  ?> 
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <input type="submit" name="submit" value="Update Video Album" class="btn btn-info pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
          <!-- /.box-body -->
