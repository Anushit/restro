        ...
        <div class="card-body"> 
           <!-- For Messages --> 
            ...
            <?php $image_row = 0; ?> 
              ...
              <div class="row" style="margin-bottom:10px;"><div class="col-md-6"> &nbsp; </div> <div class="col-md-6" style="text-align: right;"> <input type="button" name="addimg" value="Add Video" class="btn btn-warning addimg"> </div> </div>
              <div class="row">
