      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           ...
           <!-- For Messages -->
            ...
            <?php echo form_open_multipart(base_url('banner/add'), 'class="form-horizontal"
             id="bannerForm"'); ?> 
              ...
              <div class="form-group row"> 
                ...
                <label for="title_first" class="col-sm-6 control-label">First Title</label>  
                  <input type="text" name="title_first" class="form-control" id="title_first" placeholder="" value="<?= set_value('title_first'); ?>">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <label for="title_second" class="col-sm-6 control-label">Second Title </label>  
                  <input type="text" name="title_second" class="form-control" id="title_second" placeholder="" value="<?= set_value('title_second'); ?>">
                </div> 
                <div class="col-sm-6">
                <label for="url_link" class="col-sm-6 control-label">URL </label>  
                  <input type="text" name="url_link" class="form-control" id="url_link" placeholder="" value="<?= set_value('url_link'); ?>">
                </div> 
              </div>
              ...
              <div class="form-group row">  
                ...
                <div class="col-md-6">
                  <label for="status" id="status" class="col-sm-6 control-label">Select Status <span class="red">*</span></label>                  
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <input type="submit" name="submit" value="Add Banner" class="btn btn-submit btn-info pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
          <!-- /.box-body -->
