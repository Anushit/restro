      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           ...
           <!-- For Messages -->
            ...
            <?php echo form_open_multipart(base_url('tour_list/add'), 'class="form-horizontal" id="tour_listForm"');  ?> 
              ...
              <div class="form-group row"> 
                ...
                <label for="name" class="col-sm-6 control-label">Name <span class="red">*</span></label>  
                  <input type="text" name="tour_name" class="form-control" id="tour_name" placeholder="" value="<?= set_value('tour_name'); ?>">
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <input type="submit" name="submit" value="Add Tour" class="btn btn-info pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
          <!-- /.box-body -->
