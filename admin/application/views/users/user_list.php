      ...
      <div class="card-header">
        ...
        <div class="d-inline-block float-right">
          <div class="btn-group margin-bottom-20"> 
            <a href="<?= base_url() ?>users/create_users_pdf" class="btn btn-secondary">Export as PDF</a>
            <a href="<?= base_url() ?>users/export_csv" class="btn btn-secondary">Export as CSV</a>
          </div>
          <?php if(@$this->general_user_premissions['users']['is_add']==1){ ?>
          <a href="<?= base_url('users/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add New Customer</a>
           <?php } ?> 
        </div>
      </div>
    </div>
