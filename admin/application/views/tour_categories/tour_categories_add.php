      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-header">
          ...
          <div class="d-inline-block">
              ...
              Add Tour New Category </h3>

          </div>

          <div class="d-inline-block float-right">

            <a href="<?= base_url('tour_categories'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Tour Category List</a>
        ...
        <div class="card-body">   
           ...
           <!-- For Messages -->
            ...
            <?php echo form_open_multipart(base_url('tour_categories/add'), 'class="form-horizontal" id="categoryForm"');  ?> 
              ...
              <div class="form-group row"> 
                ...
                <label class="control-label">Banner Image</label><br/>
                  <?php if(!empty($cat['banner_image'])): ?>
                     <p><img src="<?= base_url($cat['banner_image']); ?>" class="image logosmallimg"></p>
                 <?php endif; ?>
                 <input type="file" name="banner_image">
                 <p><small class="text-success">Allowed Types: gif, jpg, png, jpeg</small></p>
                 <input type="hidden" name="old_bannerimage" value="<?php echo html_escape(@$cat['banner_image']); ?>">
               </div>
              </div>
              <div class="form-group">
                <div class="col-md-12">
                  <input type="submit" name="submit" value="Add Tour Category" class="btn btn-info pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
          <!-- /.box-body -->
