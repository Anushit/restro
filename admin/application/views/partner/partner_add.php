      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           ...
           <!-- For Messages -->
            ...
            <?php echo form_open_multipart(base_url('partner/add'), 'class="form-horizontal" id="partnerForm"');  ?> 
              ...
              <div class="form-group row">
                ...
                <label for="mobile" class="col-sm-6 control-label">Mobile<span class="red">*</span></label>  
                  <input type="text" name="mobile" class="form-control" id="mobile" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g, '')" placeholder="" value="<?= set_value('mobile'); ?>">
                </div>
                <div class="col-sm-6">
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <input type="submit" name="submit" value="Add Partner" class="btn btn-info pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
          <!-- /.box-body -->
