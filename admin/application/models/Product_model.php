<?php
	class Product_model extends CI_Model{
        ...
        public function get_product_by_id($id){
			$query = $this->db->get_where('ci_products', array('id' => $id,'deleted'=>0));
		...
		public function get_product_by_slug($slug){
			$query = $this->db->get_where('ci_products', array('slug' => $slug,'deleted'=>0));
			return $result = $query->row_array();
		}
...
*/
		...
		public function getProductimages($id) {
		 ...
		 public function all_products($cat_id, $search, $start, $limit){
	    	$this->db->select('p.*,pi.image');
			$this->db->from('ci_products as p');
			if($search != ''){
...
/*			print_r($this->db->last_query()); die;
*/		}
		public function get_all_products_count($cat_id,$search)
		{
			$this->db->from('ci_products as p');
			if($search != ''){
             $this->db->like('name', $search);
